...
<div class="text-center space-y-4 mb-6">
    <!-- Brand Name dengan Gradient dan Shadow -->
    <div class="text-4xl font-black tracking-wide">
        <span class="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent drop-shadow-lg">HEAVEN</span>
